            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 text-center" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card1" id="box">
                        <div>
                            <a href="Student-view-university-question.php" id="icon-a"><i class="fa fa-university fa-5x"></i></a>
                        </div>
                        <div>
                            <h4><a href="Student-view-university-question.php">View-University-Questions</a></h4>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 text-center" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card1" id="box">
                        <div>
                            <a href="student-view-mcq.php" id="icon-a"><i class="fa fa-book fa-5x"></i></a>
                        </div>
                        <div>
                            <h4><a href="student-view-mcq.php">MCQ</a></h4>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 text-center" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card1" id="box">
                        <div>
                            <a href="student-profile.php" id="icon-a"><i class="fa fa-users fa-5x"></i></a>
                        </div>
                        <div>
                            <h4><a href="student-profile.php">My-Profile</a></h4>
                        </div>
