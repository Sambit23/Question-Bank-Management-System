                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto me-5 mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="Staff-view-university-question.php">Back</a>
                            </li>
            ...
            <div class="container">
                ...
                <h1 style="color:white">
                    Filter</h1>
                                ...
                                <form action="staff-university-filter.php" method="POST">
                  ...
                  <tbody>
                      ...
                      if(isset($_POST['submit'])){
                        ...
                        // || $course != "" || $branch != "" || $subject != "" || $year != "" ||
                        // $semester != ""and course='$course' and branch='$branch' and subject='$subject' and 
                            // year=$year and semester='$semester'
                        if($university_name != "" ){
                          $qry="select * from  university_questions where universityname='$university_name'";
                            ...
                            if($res->num_rows>0){
                                while($row=$res->fetch_assoc()){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "<a href=\"staff-delete-university-question2.php?delete=$row[id]\">"."<i class=\"fa fa-trash-alt fa-2x\"></i>"."</a>";?></td>
                                    </tr>
                                    <?php
                                }
                            }else{
