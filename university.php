...
<body>
    ...
    <header>
        ...
        <div class="container-fluid" data-aos="fade-up">
            ...
            <a href="admin-add-university.php"><button type="button" class="btn btn-primary float-end" name="add">Add University</button></a>
...
if($result->num_rows>0){
    while($row = $result->fetch_assoc()){
        ...
        echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"update-university.php?updateid=$row[id]\">"."<i class=\"fa fa-sync fa-2x\"></i>"."</a>"."</td>";
        
        echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"delete-university.php?delete=$row[id]\">"."<i class=\"fa fa-trash-alt fa-2x\"></i>"."</a>"."</td>";
