...
if(isset($_POST['update'])){
    ...
    $qry="update course set course='$Course' where cid=$id";

    if($con->query($qry)){
        header("location:courses.php");
    }else{
        header("location:admin-update-course.php");
    }
}


$qry2="select * from course where cid=$id ";
...
<div class="input-group flex-nowrap">
    ...
    <input name="Course" value=<?php echo $Course;?> type="text" class="form-control" autocomplete="off" placeholder="Course" aria-describedby="addon-wrapping">
</div>
 <br>
