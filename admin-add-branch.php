    ...
    <header>
        ...
        <div class="container" data-aos="fade-up">
           ...
           <br><br>
                    ...
                    <form action="add-branch-details.php" method="POST">
                            <div class="row">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input name="Branch" type="text" class="form-control" autocomplete="off" placeholder="Branch"  aria-label="Username" aria-describedby="addon-wrapping" >
                            </div>
                            <br>
...
var msg=confirm("Do you want to add the Branch?");
if(msg){
  return true;
}
}
