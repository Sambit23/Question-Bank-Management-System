...
<body>
    ...
    <div class="section-title">
            ...
            <a href="admin-staff-regs.php"><button type="button" class="btn btn-primary float-end me-5" name="add">Add Staff</button></a>
            <br><br><br>
      <div class="container-fluid">
...
if($result->num_rows>0){
    while($row = $result->fetch_assoc()){
        ...
        echo "<td style=\"border:2px solid black;\">".$row['address']."</td>";
        echo "<td style=\"border:2px solid black;\">".$row['username']."</td>";
        echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"update-staff.php?updateid=$row[id]\">"."<i class=\"fa fa-sync fa-2x\"></i>"."</a>"."</td>";
        
        echo "<td  class=\"ps-4\">"."<a href=\"delete-staff.php?delete=$row[id]\">"."<i class=\"fa fa-trash-alt fa-2x\"></i>"."</a>"."</td>";
