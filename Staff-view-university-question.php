...
<br><br><br>
<div><a type="button" href="staff-university-filter.php"  class="btn btn-outline-primary">Filter<i class="fas fa-filter"></i></a></div>
            <br><br>
<div class="container-fluid">
...
if($row['approved'] =="0"){
    echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a>"."Pending...<i class=\"fa fa-hourglass-end \"></i>"."</a>"."</td>";
}
else{
    echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a>Approved<i class=\"fa fa-check-circle\"></i></a>"."</td>";
}

echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"staff-delete-university-question.php?delete=$row[id]\">"."<i class=\"fa fa-trash-alt fa-2x\"></i>"."</a>"."</td>";
