            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 text-center" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card1" id="box">
                        <div>
                            <a href="Staff-University-q.php" id="icon-a"><i class="fa fa-university fa-5x"></i></a>
                        </div>
                        <div>
                            <h4><a href="Staff-University-q.php">University-Questions</a></h4>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 text-center" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card1" id="box">
                        <div>
                            <a href="Staff-MCQ.php" id="icon-a"><i class="fa fa-book fa-5x"></i></a>
                        </div>
                        <div>
                            <h4><a href="Staff-MCQ.php">MCQ</a></h4>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 text-center" data-aos="zoom-in" data-aos-delay="100">
                    <div class="card1" id="box">
                        <div>
                            <a href="staff-profile.php" id="icon-a"><i class="fa fa-users fa-5x"></i></a>
                        </div>
                        <div>
                            <h4><a href="staff-profile.php">Profile</a></h4>
                        </div>
