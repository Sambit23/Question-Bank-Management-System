...
<body>
    ...
    <header>
        ...
        <div class="container-fluid" data-aos="fade-up">
            ...
            <a href="admin-add-course.php"><button type="button" class="btn btn-primary float-end me-3" name="add">Add Course</button></a>
                ...
                <div class="table-responsive">
                    <table class="table" style="color: black;background-color: white; padding: 20px; border-radius: 5px;">
                        <tr>
                            ...
                            <th style="border: 2px solid black;">Delete Course</th>
                        </tr>
                        <?php
...
if($result->num_rows>0){
    while($row = $result->fetch_assoc()){
        ...
        echo "<td style=\"border:2px solid black;\">".$row['cid']."</td>";
        echo "<td style=\"border:2px solid black;\">".$row['course']."</td>";
       
       
        echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"admin-update-course.php?updateid=$row[cid]\">"."<i class=\"fa fa-sync fa-2x\"></i>"."</a>"."</td>";
        echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"admin-delete-course.php?delete=$row[cid]\">"."<i class=\"fa fa-trash-alt fa-2x\"></i>"."</a>"."</td>";
...
?>
                ...
                <br>
                <a href="admin-add-branch.php"><button type="button" class="btn btn-primary float-end" name="add">Add Branch</button></a>
                <br><br><br>
                <div class="table-responsive">
                ...
                die("Connection lost");
                    ...
                    if($result->num_rows>0){
                        while($row = $result->fetch_assoc()){
                            ...
                            echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"admin-update-branch.php?updateid=$row[id]\">"."<i class=\"fa fa-sync fa-2x\"></i>"."</a>"."</td>";
        
                            echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"admin-delete-branch.php?delete=$row[id]\">"."<i class=\"fa fa-trash-alt fa-2x\"></i>"."</a>"."</td>";
...
?>
                ...
                <br>
                <a href="admin-add-subject.php"><button type="button" class="btn btn-primary float-end" name="add">Add Subject</button></a>
                <br><br><br>
                <div class="table-responsive">
                        ...
                        $query="select * from subject";
                            ...
                            if($result->num_rows>0){
                               while($row = $result->fetch_assoc()){
                                   ...
                                   echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"admin-update-subject.php?updateid=$row[id]\">"."<i class=\"fa fa-sync fa-2x\"></i>"."</a>"."</td>";
        
                                  echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"admin-delete-subject.php?delete=$row[id]\">"."<i class=\"fa fa-trash-alt fa-2x\"></i>"."</a>"."</td>";
