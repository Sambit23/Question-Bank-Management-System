...
if(isset($_POST['update'])){
    ...
    $qry="update university set universityname='$university',city='$city',state='$state' where id=$id";

    if($con->query($qry)){
        header("location:university.php");
    }else{
        header("location:update-university.php");
    }
}


$qry2="select * from university where id=$id ";
...
<div class="input-group flex-nowrap">
     <span class="input-group-text" id="addon-wrapping">University Name</span>
    <input name="university" value=<?php echo $university;?> type="text" class="form-control" autocomplete="off" placeholder="University Name" id="user_name" aria-label="Username" aria-describedby="addon-wrapping" required>
</div>
 <br>
<div class="input-group flex-nowrap">
    <span class="input-group-text" id="addon-wrapping">City</span>
    <input name="city" value=<?php echo $city;?> type="text" class="form-control" autocomplete="off" placeholder="City" id="user_name" aria-label="Username" aria-describedby="addon-wrapping" required>
</div>
<br>
<div class="input-group flex-nowrap">
     <span class="input-group-text" id="addon-wrapping">State</span>
    <input name="state" value=<?php echo $state;?> type="text" class="form-control" placeholder="State" aria-label="Username" autocomplete="off" aria-describedby="addon-wrapping" required>
