...
<body>
    ...
    <br><br>
                    <form action="add-course-details.php" method="POST">
                            <div class="row">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input name="Course" type="text" class="form-control" autocomplete="off" placeholder="Course" aria-label="Username" aria-describedby="addon-wrapping" required>
                            </div>
...
var msg=confirm("Do you want to add the course?");
if(msg){
  return true;
}
}
