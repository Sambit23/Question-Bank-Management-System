...
if(isset($_POST['update'])){
   $Branch=$_POST['Branch'];
    ...
    $qry="update branch set Branch='$Branch' where id=$id";

    if($con->query($qry)){
        header("location:courses.php");
    }else{
        header("location:admin-update-branch.php");
    }
}


$qry2="select * from branch where id=$id ";
...
<div class="input-group flex-nowrap">
    ...
    <input name="Branch" value=<?php echo  $Branch;?> type="text" class="form-control" autocomplete="off" placeholder="Branch"  aria-describedby="addon-wrapping">
</div>
<br>

<a href="courses.php" class="btn btn-primary float-start">Cancel</a>

<button type="submit" value="update" name="update" class="btn btn-primary float-end">update</button>
</form>
