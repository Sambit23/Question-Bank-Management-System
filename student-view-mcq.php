...
while($row = $result->fetch_assoc()){
    ...
    // echo "<div class=\"card-body\">";
        echo    "<div class=\"col-lg-4 col-md-4 d-flex align-items-stretch mt-4 text-center\" data-aos=\"zoom-in\" data-aos-delay=\"100\">";
          
      
        
            echo        "<div class=\"card1\" id=\"box\" style=\"width: 100%;height:auto;\">";
            echo           "<div>";
            echo                "<a href=\"mcq-students.php?subject=$row[subject]\" id=\"icon-a\"><i class=\"fa fa-book fa-5x\"></i></a>";
            echo            "</div>";
            echo            "<div>";
            echo               "<h4><a href=\"mcq-students.php?subject=$row[subject]\">$row[subject]</a></h4>";
            echo            "</div>";
            echo        "</div>";
