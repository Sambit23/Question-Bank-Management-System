            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto me-4 mb-2 mb-lg-0">
                        ...
                        <button type="submit" name="logout" class="btn btn-primary">Logout  <i class="fas fa-sign-out-alt"></i></button>
...
<div class="container-fluid">
<a href="staff-add-mcq.php" type="button" class="btn btn-outline-primary">Add Mcq</a>
<a href="staff-mcq-filter.php" type="button" class="btn btn-outline-primary">Filter</a>
<br><br>
<div class="table-responsive">


<table class="table" style="color: black;background-color: whitesmoke; padding: 20px; border-radius: 5px;">
    <tr>
...
echo "<td style=\"border:2px solid black;\">"."<pre>".$row['question']."</pre>"."</td>";
...
echo "<td style=\"border:2px solid black;\">"."<pre>".$row['explanation']."</pre>"."</td>";
echo "<td style=\"border:2px solid black;\">".$row['uploaded_by']."</td>";

echo "<td style=\"border:2px solid black;\" class=\"ps-4\">"."<a href=\"staff-delete-mcq-question.php?delete=$row[q_id]\">"."<i class=\"fa fa-trash-alt fa-2x\"></i>"."</a>"."</td>";

echo "</tr>";

}
}else{
echo "<span style=\"color:white\">"."There's no data in the table"."</span>";
}
