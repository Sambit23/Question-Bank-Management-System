...
<br><br><br><br><br>
       ...
       <div class="card2" style="width: 28rem; height:auto; ">
...
if($result->num_rows>0){
    $row = $result->fetch_assoc();
        ...
        // echo "<a href=\"$row[img]\"><img src='".$row['img']."' style=\"height:10rem; width:10rem;  \"></a>";
       
 echo " <tbody style=\"color:white; text-align:left;\">";
 echo " <tr >";
   ...
   echo "<tr>";
     ...
     echo "</tr>";
   echo "<tr>";
    //  echo "<th scope=\"row\" style=\"border:transparent\">"."<a class=\"btn btn-primary float-start\" href=\"delete-student-profile.php?delete=$row[id]\">"."Delete"."</a>"."</th>";
    
     echo "<td  style=\"border:transparent\">"."<a class=\"btn btn-primary float-start\" href=\"update-student-profile.php?updateid=$row[id]\">"."Update"."</a>"."</td>";
